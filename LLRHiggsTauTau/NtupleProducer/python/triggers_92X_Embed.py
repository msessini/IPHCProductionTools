...
### === mu tauh triggers - OK
    cms.PSet (
        ...
        path1 = cms.vstring ("hltL3crIsoL1sMu18erTau24erIorMu20erTau24erL1f0L2f10QL3f20QL3trkIsoFiltered0p07",""),
        path2 = cms.vstring ("hltL1sMu18erTau24erIorMu20erTau24er",""),
        path3 = cms.vstring (""),
        path4 = cms.vstring (""),
        leg1 = cms.int32(13),
        leg2 = cms.int32(15),
...
### === tauh tauh triggers - OK
    ...
    cms.PSet (
        ...
        path1 = cms.vstring ("hltDoubleL2IsoTau26eta2p2"),
        path2 = cms.vstring ("hltDoubleL2IsoTau26eta2p2"),
        path3 = cms.vstring (""),
        path4 = cms.vstring (""),
        leg1 = cms.int32(15),
        leg2 = cms.int32(15),
